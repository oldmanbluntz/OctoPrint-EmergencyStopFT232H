...
plugin_identifier = "EmergencyStopFT232H"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_EmergencyStopFT232H"

# The plugin's human readable name. Can be overwritten within OctoPrint's internal data via __plugin_name__ in the
# plugin module
plugin_name = "OctoPrint-Emergencystopft232h"
...
# module
plugin_description = "Send M119 with a physical Button with the FT232H USB Breakout Board"
...
plugin_url = "https://github.com/oldmanbluntz/OctoPrint-EmergencystopFT232H"
